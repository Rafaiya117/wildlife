<?php global $sSpecies_plantl_data ; ?>
<div class="content-wrapper" style="margin-top: px; min-height: 1000px;">
    ...
    <section class="content-header content-header_2 mb-4" id="dash_head" style= "text-align: center; font-size: 30px;">
      ...
      <b class="btn-warning btn-lg banner-btn">Protected Plants রক্ষিত উদ্ভিদ</b>
     </h2> 
     <br>
   </section>
    <!-- Main content -->
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <tr role="row">
                                        ...
                                        for ($i=0,$ilen = sizeof($sSpecies_plantl_data); $i < $ilen; $i++) {
                                           
                                            
                                            
                                            $path1 = '../dist/species_img/image_nfound.png';
                                            $image_path = IMAGE_URL . ($sSpecies_plantl_data[$i]['id']).'.webp';
                                            ...
                                            echo "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_plantl_data [$i]['bangla_name']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_plantl_data [$i]['english_name']) . "</td>";
                                            echo "<td style='text-align:center;'><i>" . ($sSpecies_plantl_data [$i]['scientific_name']) . "</i></td>";
                                            // echo "<td style='text-align:center;'>" . ($sSpecies_plantl_data [$i]['scientific_Ref']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_plantl_data [$i]['schedule']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_plantl_data [$i]['IUCN']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_plantl_data [$i]['IUCN_Bangladesh']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_plantl_data [$i]['CITES']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_plantl_data [$i]['type']) . "</td>
                                            </tr>";
