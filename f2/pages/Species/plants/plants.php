...
<div class="content-wrapper">
   ...
   <section class="content-header" id="dash_head" style= "text-align: center; font-size: 30px;">
      ...
      <b>Sub Group 11<br>সাব-গ্রুপ ১১</b>
     </h2> 
     <br>
   </section>
   <!-- Main content -->
   <section class="container">
     <div class="row">
      <div class="col-md-10">
        ...
        <div class="card">
          <div class="image" onclick="location.href='#sb_plants'">
            <img src="../dist/Requested icon/Protected plants.svg" height="100" />
          </div>
          <div class="card-inner">
            <div class="header">
              <h2><a href="#sb_plants">Plant</a></h2>
            </div>
          </div>
        </div>
      </div>
