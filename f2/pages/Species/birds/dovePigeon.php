...
<div class="content-wrapper" style="margin-bottom:15px; min-height: 1000px;">
    ...
    <section class="content-header content-header_2 mb-4" id="dash_head" style= "text-align: center; font-size: 30px;">
      ...
      <b class="btn-warning btn-lg banner-btn">Dove & Pigeon ঘুঘু এবং কবুতর</b>
     </h2> 
     <br>
   </section>
    <!-- Main content -->
                                ...
                                <div class="col-sm-12">
                                    <table id="example2 " class="table table-bordered table-hover dataTable no-footer table-margin" style="font-size: 18px;" role="grid" aria-describedby="example2_info">
                                        ...
                                        for ($i=0,$ilen = sizeof($sSpecies_dovePigeon_data ); $i < $ilen; $i++) {
                                            ...
                                            $image_path = IMAGE_URL . ($sSpecies_dovePigeon_data[$i]['id']).'.webp';
                                            ...
                                            echo "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_dovePigeon_data [$i]['bangla_name']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_dovePigeon_data[$i]['english_name']) . "</td>";
                                            echo "<td style='text-align:center;'><i>" . ($sSpecies_dovePigeon_data [$i]['scientific_name']) . "</i></td>";
                                            // echo "<td style='text-align:center;'>" . ($sSpecies_dovePigeon_data [$i]['scientific_Ref']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_dovePigeon_data [$i]['schedule']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_dovePigeon_data [$i]['IUCN']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_dovePigeon_data [$i]['IUCN_Bangladesh']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_dovePigeon_data [$i]['CITES']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_dovePigeon_data [$i]['type']) . "</td>
                                            </tr>";
