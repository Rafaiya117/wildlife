...
<div class="content-wrapper">
   ...
   <section class="content-header" id="dash_head" style= "text-align: center; font-size: 30px;">
      ...
      <b>Sub Group 10<br>সাব-গ্রুপ ১০</b>
     </h2> 
     <br>
   </section>
   <!-- Main content -->
...
<div class="col-md-5" style="text-align:center">
  <div class="card">
    <div class="image" onclick="location.href='#coral_sp'">
      <img src="../dist/Requested icon/Coral.svg"height="100" />
    </div>
    <div class="card-inner">
      <div class="header">
        <h2><a href="#coral_sp">Coral</a></h2>
