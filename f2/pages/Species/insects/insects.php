...
<div class="content-wrapper">
   ...
   <section class="content-header" id="dash_head" style= "text-align: center; font-size: 30px;">
      ...
      <b>Sub Group 8<br>সাব-গ্রুপ ৮</b>
     </h2> 
     <br>
   </section>
   <!-- Main content -->
     ...
     <div class="row">
      <div class="col-md-10">
        <div class="col-md-5" style="text-align:center">
          <div class="card">
              <div class="image" onclick="location.href='#butterfly'">
                <img src="../dist/Requested icon/Insects.svg" height="100" />
              </div>
              <div class="card-inner">
                  <div class="header">
                    <h2><a href="#butterfly">Butterfly</a></h2>
                  </div>
                </div>
              </div>
            </div>
