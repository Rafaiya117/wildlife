...
<div class="content-wrapper" style="margin-top: 00px; min-height: 1000px;">
    ...
    <section class="content-header content-header_2" id="dash_head" style="text-align: center; font-size: 30px;">
        <h2 style="font-size: 30px;">
            <b class="btn-warning btn-lg banner-btn"> Ray fish শাপলাপাতা মাছ</b>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <?php echo "<tbody id='find'>";
                                        ...
                                        for ($i=0,$ilen = sizeof($sSpecies_ray_data); $i < $ilen; $i++) {
                                            ...
                                            $image_path = IMAGE_URL . ($sSpecies_ray_data[$i]['id']).'.webp';
                                            ...
                                            echo "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_ray_data [$i]['bangla_name']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_ray_data [$i]['english_name']) . "</td>";
                                            echo "<td style='text-align:center;'><i>" . ($sSpecies_ray_data [$i]['scientific_name']) . "</i></td>";
                                            // echo "<td style='text-align:center;'>" . ($sSpecies_ray_data [$i]['scientific_Ref']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_ray_data [$i]['schedule']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_ray_data [$i]['IUCN']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_ray_data [$i]['IUCN_Bangladesh']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_ray_data [$i]['CITES']) . "</td>";
                                            echo "<td style='text-align:center;'>" . ($sSpecies_ray_data [$i]['type']) . "</td>
                                            </tr>";
