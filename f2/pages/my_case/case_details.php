        ...
        <div class="row">
            <div class="container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                         <h2 class="" id="cased">(ঙ) Other Seized Item (online/virtual/video)<br>
                                অন্যান্য জব্দকৃত মালামাল (অনলাইন/ভার্চুয়াল/ভিডিও)
