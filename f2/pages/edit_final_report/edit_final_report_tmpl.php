               ...
               <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <section class="container" id="edit_datas"></section>
                            </div>
...
<form method="POST" action="">
    <input type="hidden" class="listinBtn-danger permission" name="id" value="" />
    <input type="submit" class="listinBtn-danger" id="id" value="Permission to edit report"></form>
        <a class="listinBtn pull-left" onclick="window.history.go(-1); return false;" style="cursor: pointer;"><?php echo trans("back", 'en'); ?>
            <?php echo trans("back", 'bn'); ?></a></div>
